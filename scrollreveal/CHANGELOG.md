...
- Incomplete support for `config.viewport` was addressed. [#67](https://github.com/scrollreveal/scrollreveal/issues/67) [#68](https://github.com/scrollreveal/scrollreveal/issues/68)
